...
- AWS SES production access and verified sender/domain for transactional confirmation, full-scan command, and plugin-ready emails
- Stripe account for Checkout and paid pack downloads, deferred until after the free email-confirmed launch test
