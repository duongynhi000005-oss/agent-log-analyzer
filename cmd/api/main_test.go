...
func TestReportPageServerRendersCompletedReport(t *testing.T) {
	...
	for _, want := range []string{
		...
		"Cap command output.",
		"Generate the optimization plugin from a full scan",
		"For launch testing this is email-confirmed and free.",
		"Email for full-scan command",
		"Email me the full-scan command",
		"/api/email-unlocks",
		"RTK (Rust Token Killer, rtk-ai/rtk)",
		"https://github.com/rtk-ai/rtk",
		"Raw log TTL: not uploaded",
		"Security Receipt",
		"MCP &amp; Skill Utilization",
		"Agent Logs Analyzed",
		"Claude Code",
		"Codex",
		"timeline-bar",
